    ...
    questions: [
      {
        ...
        choices: [
          ...
          {
            name: 'Hybrid - Uses agents from both core AND a squad',
            value: 'hybrid',
          },
        ],
        default: 'core',
      },
      {
        ...
        when: (answers) =>
          answers.targetContext === 'squad' ||
          answers.targetContext === 'hybrid',
        validate: (input) => {
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        validate: (input) =>
          input.length > 20 || 'Please provide a detailed description',
      },
      {
        type: 'list',
        name: 'workflowType',
        ...
        choices: [
          {
            name: 'Sequential - Steps run one after another',
            value: 'sequential',
          },
          {
            name: 'Parallel - Multiple steps can run simultaneously',
            value: 'parallel',
          },
          {
            name: 'Conditional - Steps depend on conditions',
            value: 'conditional',
          },
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          ...
          {
            name: 'Detailed mode - Full step configuration',
            value: 'detailed',
          },
