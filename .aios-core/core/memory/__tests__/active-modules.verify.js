...
test('GotchasMemory has trackUserFeedback method', () => {
  ...
  assertDefined(
    memory.trackUserFeedback,
    'trackUserFeedback method should exist'
  );
});
...
test('GotchasMemory has getAccuracyMetrics method', () => {
  ...
  const memory = new GotchasMemory(process.cwd());
  assertDefined(
    memory.getAccuracyMetrics,
    'getAccuracyMetrics method should exist'
  );
});
...
test('GotchasMemory has getSuggestedRules method', () => {
  ...
  const memory = new GotchasMemory(process.cwd());
  assertDefined(
    memory.getSuggestedRules,
    'getSuggestedRules method should exist'
  );
});
...
test('CustomRulesLoader can categorize files', () => {
  ...
  const matchesNodeModules = loader.matchesPattern(
    'node_modules/package/index.js',
    skipPatterns
  );
  assertTrue(
    matchesNodeModules,
    'node_modules/package/index.js should match node_modules/**'
  );
...
test('SemanticMergeEngine integrates with CustomRulesLoader', () => {
  ...
  assertDefined(
    engine.getFileCategory,
    'Engine should have getFileCategory method'
  );
});
