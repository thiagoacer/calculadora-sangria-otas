...
const mockDevAgent = {
  ...
  persona_profile: {
    ...
    greeting_levels: {
      ...
      archetypal:
        '💻 Dex the Builder (♒ Aquarius) ready to construct excellence!',
    },
  },
  persona: {
  ...
  commands: [
    ...
    },
    {
      name: 'qa-gate',
      visibility: ['key'],
      description: 'Run quality gate before commit',
    },
    {
      name: 'commit',
      visibility: ['key'],
...
const mockPoAgent = {
  ...
  persona_profile: {
    ...
    greeting_levels: {
      ...
      archetypal:
        '⚖️ Pax the Balancer (♎ Libra) ready to harmonize requirements!',
    },
  },
  persona: {
