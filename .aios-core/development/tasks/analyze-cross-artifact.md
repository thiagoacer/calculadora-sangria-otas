...
consistency_analysis:
  ...
  checks:
    - name: prd_vs_architecture
      ...
      severity: HIGH
      sources:
        [docs/prd.md, docs/prd/, docs/architecture.md, docs/architecture/]
...
_Report generated by AIOS Cross-Artifact Analysis_
_Reference: Constitution Article V - Quality First_
```
...
_Cross-Artifact Analysis Task v1.0.0_
_CLI First | Quality First | Read-Only_
