...
describe('ProjectStatusLoader', () => {
  ...
  describe('getCurrentStoryInfo', () => {
    ...
    it('should detect InProgress story', async () => {
      await fs.mkdir(path.join(testRoot, 'docs', 'stories'), {
        recursive: true,
      });
  ...
  describe('getWorktreesStatus', () => {
    ...
    it('should return worktree info with required fields', async () => {
      ...
      try {
        ...
        await execa(
          'git',
          ['worktree', 'add', worktreePath, '-b', 'auto-claude/STORY-TEST'],
          {
            cwd: testRoot,
          }
        );
        ...
        expect(typeof worktrees['STORY-TEST'].uncommittedChanges).toBe(
          'number'
        );
        ...
        await execa('git', ['branch', '-D', 'auto-claude/STORY-TEST'], {
          cwd: testRoot,
        });
      } catch (error) {
  ...
  describe('generateStatus with worktrees', () => {
    it('should include worktrees in generated status', async () => {
      ...
      try {
        ...
        await execa(
          'git',
          ['worktree', 'add', worktreePath, '-b', 'auto-claude/STORY-GEN'],
          {
            cwd: testRoot,
          }
        );
        ...
        await execa('git', ['branch', '-D', 'auto-claude/STORY-GEN'], {
          cwd: testRoot,
        });
      } catch (error) {
        console.warn('Git not available, skipping test:', error.message);
