    ...
    domains: {
      ...
      deployment: {
        ...
        checks: [
          {
            id: 'DE-001',
            name: 'Deployment mode detected',
            status: 'passed',
            duration: '5ms',
          },
          {
            id: 'DE-002',
            name: 'Environment vars per env',
            status: 'passed',
            duration: '35ms',
          },
          {
      ...
      services: {
        ...
        checks: [
          {
            id: 'SI-001',
            name: 'Backlog manager operational',
            status: 'passed',
            duration: '45ms',
          },
          {
          ...
          {
            id: 'SI-003',
            name: 'MCP servers healthy',
            status: 'passed',
            duration: '180ms',
          },
          {
            id: 'SI-004',
            name: 'Memory layer status',
            status: 'passed',
            duration: '90ms',
          },
        ],
