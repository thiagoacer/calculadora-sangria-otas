...
describe('WorkflowRegistry', () => {
  ...
  describe('loadWorkflows()', () => {
    ...
    it('should throw error for invalid file path', () => {
      ...
      expect(() => badRegistry.loadWorkflows()).toThrow(
        'Workflow patterns file not found'
      );
    });
  });
  ...
  describe('getTransitions()', () => {
    it('should return transitions for valid state', () => {
      const transition = registry.getTransitions(
        'epic_creation',
        'epic_drafted'
      );
  ...
  describe('findCurrentState()', () => {
    it('should find state from command', () => {
      const state = registry.findCurrentState(
        'epic_creation',
  ...
  describe('normalizeCommand()', () => {
    it('should normalize command strings', () => {
      ...
      expect(registry.normalizeCommand('*create-epic')).toBe('create-epic');
      expect(registry.normalizeCommand('create-epic completed')).toBe(
        'create-epic'
      );
    });
